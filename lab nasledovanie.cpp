...
int main()
{
    ...
    DeusEx first = DeusEx();
    first.setName("Леонардо");
    first.setAge(12);
    first.setCatchPhrase("хочет услышать загадку.");
    first.setMagmum(0, "Чудно.");
    first.setMagmum(1, "Ладно.");
    first.setMagmum(2, "Хорошо.");
    first.setAGe(15);
    first.forecast();
    Believer F = Believer("Арнольд", 15);
    F.output();
    first.bonus();
    F.output2();
    return 0;
